...
const DescriptionBox = () => {
  return (
    <div className="my-[120px] mx-[170px]">
      <div className="flex">
        <div className="flex items-center justify-center text-[14px] font-semibold w-[160px] h-[65px] border border-[#d0d0d0]">Description</div>
        <div className="flex items-center justify-center text-[14px] font-semibold w-[160px] h-[65px] border border-[#d0d0d0] bg-[#fbfbfb] text-[#555]">Reviews (122)</div>
      </div>
      <div className="flex flex-col gap-[25px] border border-[#d0d0d0] p-[40px] pb-[65px]">
